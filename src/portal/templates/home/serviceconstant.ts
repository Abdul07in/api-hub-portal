export const CONTENT = {
  ...
  benefits: {
    title: "Benefits",
    items: [
      { title: "Direct Integration", desc: "Instant solutions without manual uploads." },
      { title: "Real Time", desc: "Immediate processing of transactions." },
      { title: "Secure", desc: "Encrypted environment, compliance ready." },
      { title: "Cost Saving", desc: "Reduce infrastructure and resource needs." },
    ],
  },
  howItWorks: {
    title: "How It Works",
    steps: ["Sign Up", "Explore APIs", "Test in Sandbox", "Request Approval", "Go Live"],
  },
  features: {
