      ...
      <Container maxWidth="xl" sx={{ py: 6 }}>
        ...
        >
          ...
          <Box>
            ...
            <Stack spacing={0.5}>
              ...
              <Link component={RouterLink} to="/sandbox" color="inherit" underline="hover">Sandbox</Link>
          ...
          <Box>
            ...
            <Stack spacing={0.5}>
              ...
              <Link href="#" color="inherit" underline="hover">Status Page</Link>
          ...
          <Box>
            ...
            <Stack direction="row" spacing={1}>
              ...
              <IconButton size="small" sx={{ color: "#fff" }}><TwitterIcon /></IconButton>
              <IconButton size="small" sx={{ color: "#fff" }}><YouTubeIcon /></IconButton>
            </Stack>
        ...
        >
          ...
          <Stack direction="row" spacing={2}>
            <Link href="#" color="inherit" underline="hover" sx={{ fontSize: 12 }}>Privacy Policy</Link>
            <Link href="#" color="inherit" underline="hover" sx={{ fontSize: 12 }}>Terms of Use</Link>
            <Link href="#" color="inherit" underline="hover" sx={{ fontSize: 12 }}>Disclaimer</Link>
          </Stack>
        </Stack>
      </Container>
    </Box>
